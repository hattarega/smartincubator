...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('#btn-default-i').addEventListener('click', function () {
    notifier.show('Default!', 'I am a default notification.', '', '../{{ asset('{{ asset('assets/') }}') }}images/notification/clock-48.png', 0);
  });

  document.querySelector('#btn-info-i').addEventListener('click', function () {
    notifier.show('Reminder!', 'You have a meeting at 10:30 AM.', 'info', '../{{ asset('{{ asset('assets/') }}') }}images/notification/survey-48.png', 0);
  });

  document.querySelector('#btn-success-i').addEventListener('click', function () {
    notifier.show('Well Done!', 'You just submit your resume successfully.', 'success', '../{{ asset('{{ asset('assets/') }}') }}images/notification/ok-48.png', 0);
  });
  ...
  document.querySelector('#btn-warning-i').addEventListener('click', function () {
    notifier.show(
      ...
      'warning',
      '../{{ asset('{{ asset('assets/') }}') }}images/notification/medium_priority-48.png',
      0
    );
  });

  document.querySelector('#btn-danger-i').addEventListener('click', function () {
    notifier.show('Sorry!', 'Could not complete your transaction.', 'danger', '../{{ asset('{{ asset('assets/') }}') }}images/notification/high_priority-48.png', 0);
  });

  document.querySelector('#btn-default-ac').addEventListener('click', function () {
    notifier.show('Default!', 'I am a default notification.', '', '../{{ asset('{{ asset('assets/') }}') }}images/notification/clock-48.png', 4000);
  });

  document.querySelector('#btn-info-ac').addEventListener('click', function () {
    notifier.show('Reminder!', 'You have a meeting at 10:30 AM.', 'info', '../{{ asset('{{ asset('assets/') }}') }}images/notification/survey-48.png', 4000);
  });

  document.querySelector('#btn-success-ac').addEventListener('click', function () {
    notifier.show('Well Done!', 'You just submit your resume successfully.', 'success', '../{{ asset('{{ asset('assets/') }}') }}images/notification/ok-48.png', 4000);
  });
  ...
  document.querySelector('#btn-danger-ac').addEventListener('click', function () {
    notifier.show('Sorry!', 'Could not complete your transaction.', 'danger', '../{{ asset('{{ asset('assets/') }}') }}images/notification/high_priority-48.png', 4000);
  });
  ...
  var showNotification = function () {
    notificationId = notifier.show(
      ...
      'info',
      '../{{ asset('{{ asset('assets/') }}') }}images/notification/survey-48.png',
      4000
    );
  };
