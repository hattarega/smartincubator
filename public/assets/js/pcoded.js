...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-white.svg');
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-white.svg');
    }

    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-white.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-white.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-white.svg');
    }
    ...
    dark_flag = false;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-dark.svg');
    }
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-dark.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-dark.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../{{ asset('{{ asset('assets/') }}') }}images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-layout > a.active');
    if (control) {
      document.querySelector('.theme-layout > a.active').classList.remove('active');
